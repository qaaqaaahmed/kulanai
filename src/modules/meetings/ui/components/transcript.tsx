...
export const Transcript = ({ meetingId }: Props) => {
  ...
  return (
    <div className="bg-white rounded-lg border px-4 py-5 flex flex-col gap-4 w-full">
      <p className="text-sm font-medium capitalize">Transcript</p>
